...
b2=0.12; %thickness of the aerofoil

%chords along the span 
...
t2_alongSpan= ((((N_alongSpan*(b2^2))./(3.62*YM_of_Materials(1))).^(1/3)))*1000; %thickness at each spanwise stations
