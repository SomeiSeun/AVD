function LoadCase1 = fuselage_distributions_LC1(components, n, numSections, W0, mainLength, wingRootLE, cRootWing, CL_trimHoriz,rho_cruise, V_Cruise, CL_trimWings, etaH, SHoriz, SWing);
...
LoadCase1.sections=fusSections_x;
LoadCase1.TotalSF1=SF_Total_LC1; %sum of inertial and tail load
LoadCase1.TotalBM1=BM_Total_LC1; %sum of inertial and tail load
LoadCase1.SFTT=SF_TT; %just tail load
LoadCase1.BMTT=BM_TT; %just tail load
