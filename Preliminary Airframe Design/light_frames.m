...
fuselage.web_height = linspace(0.05,0.2,40);
fuselage.flange_width = linspace(0,0.1,40);
...
for i = 1:length(fuselage.web_height)
    for j = 1:length(fuselage.flange_width)
        ...
        fuselage.frame_area(i) = (2 * fuselage.flange_width(j) + fuselage.web_height(i)) * (fuselage.frame_t(i,j));
    end
end
end