...
% Vs is the stall speed during landing approach 
% Ixx is the second moment of area of the aircraft
...
C_DR = 0.9;          % Average value of 0.9 is selected for wing-horizontal, tail-vertical, tail rolling drag coefficient
