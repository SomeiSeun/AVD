...
function [C_Duc,C_Dflaps_takeoff,C_Dflaps_landing,C_Dwe,C_Dfu,CD_Misc]=MiscD(Area_ucfrontal,Sref,flapspan,wingspan,flap_deflection_takeoff,flap_deflection_landing,A_eff,d,beta)
C_Duc=2.25*(Area_ucfrontal/Sref);   % same value for take-off and landing. Nothing for cruise
C_Dflaps_takeoff=0.0023*(flapspan/wingspan)*flap_deflection_takeoff;%flaps and slats are not deployed during cruise. Only take-off and values will be calculated.
C_Dflaps_landing=0.0023*(flapspan/wingspan)*flap_deflection_landing;
...
CD_Misc=C_Duc+C_Dflaps_takeoff+C_Dflaps_landing+C_Dwe+C_Dfu;
end 