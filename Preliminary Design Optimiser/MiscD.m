...
function [CD_Misc_Takeoff,CD_Misc_Cruise,CD_Misc_Landing]=MiscD(Area_ucfrontal,Sref,flapspan,wingspan,flap_deflection_takeoff,flap_deflection_landing,A_eff,d,beta)
