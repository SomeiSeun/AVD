...
function [CL_a,CL_max_clean,CL_aflapsh,delta_alpha_zero,delta_CL_max]=WingLift(AspectRatio,S_exposed,Sref,d,b,M,sweepanglemax,Cl_am,chord_ratio,Cl_max,flapped_ratio,sweep_quarterchord,sweep_HLD,delta_alpha_zeroairfoil)
