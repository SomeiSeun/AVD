...
function [maxLiftLanding,maxLiftTakeoff,AoA_Stall_Wing,AoA_Stall_Tail,CL_max_Total_Clean]=TotalLift(CL_max_landing,CL_max_takeoff,CL_max_clean,CL_a_Total,CL_ah,CL_max_h,SHoriz,Sref,rho_landing,V_landing,rho_takeoff,V_takeoff,alpha_zero_takeoff,alpha_zero_landing)
CL_max_Total_Landing=CL_max_landing+(0.9*CL_max_h*(SHoriz/Sref));
CL_max_Total_Takeoff=CL_max_takeoff+(0.9*CL_max_h*(SHoriz/Sref));
CL_max_Total_Clean= CL_max_clean+(0.9*CL_max_h*(SHoriz/Sref)); 
