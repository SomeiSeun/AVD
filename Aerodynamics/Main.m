...
[Vstall_Approach]= StallAnalysis(W/S,rho,Clmax);
...
[Re,Re_cutoff,Cf,FF1,FF2,FF3,CD_Parasitic]=Parasitic();
%Determine the Miscellaneous Drag Component: 
[C_Duc,C_Dflaps,C_Dwe,C_Dfu]=MiscD(Area_ucfrontal,Sref,flapspan,wingspan,flapdeflection,A_eff,d,beta);
