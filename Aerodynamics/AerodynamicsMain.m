...
%% Save Variables to AerodynamicsFINAL.mat
save('AerodynamicsFINAL.mat','CL_a_Total','CL_ah','CL_a_M0','CL_max_clean','alpha_zero_takeoff','alpha_zero_landing','delta_CL_max','CL_max_takeoff','CL_max_landing','CL_max_h','zeroAlphaLCT','maxLiftLanding','maxLiftTakeoff','CD_0_Total','CD_Total','Drag_Landing','LtoDMax','CD_min','V_Stall_Landing','AoA_Stall_Tail','AoA_Stall_Wing')
