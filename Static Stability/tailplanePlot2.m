function tailplanePlot2(Bruhxmin, xnp, CGempty, CGfull, wingPlanform, horizPlanform, vertPlanform, aftLength, mainLength, frontLength, fusDiamOuter, aftDiameter)
...
plot(CGfull(1),CGfull(2),'go')
plot(CGempty(1),CGempty(2),'k+', 'MarkerSize', 10)
plot(CGempty(1),CGempty(2),'ko','MarkerSize', 10)
plot(xnp(1),CGfull(2),'ro')
plot(Bruhxmin, Bruhy, 'xk', 'LineWidth', 0.1) % x min for ground clearance being possible
grid minor
...
plot(CGfull(1),CGfull(3),'go')
plot(xnp(1),CGfull(3),'ro')
grid minor
